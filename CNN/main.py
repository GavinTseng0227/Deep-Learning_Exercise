...
if __name__ == '__main__':
    ...
    # fetch training data
    train_path = r'/Users/a32allen/Desktop/RWTH Aachen/2022WS/ML/Exercise' \
                 r'/exercise-5/cityscapesExtracted/cityscapesExtractedResized'
    train_dataset = city_scapes(datapath=train_path,
                                transform=train_dataset_transform)
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size)

    # fetch validation data
    val_path = r'/Users/a32allen/Desktop/RWTH Aachen/2022WS/ML/Exercise' \
               r'/exercise-5/cityscapesExtracted/cityscapesExtractedValResized'
    ...
    test_path = r'/Users/a32allen/Desktop/RWTH Aachen/2022WS/ML/Exercise' \
                r'/exercise-5/cityscapesExtracted/cityscapesExtractedTestResized'
    ...
    # define paths
    folder = "saves"
    save_network = osp.join(r'/Users/a32allen/Desktop/RWTH Aachen/2022WS/ML/Exercise/exercise-5', folder)
